...
<title>Historial de compras | ChocoLuxury</title>
...
<body class="sub_page">
	...
	<div class="main_body_content">
		...
		<div class="volver">
			<a href="verpedidoscliente.jsp"><i class="fa fa-arrow-left"
				aria-hidden="true"></i> Mis pedidos</a>
		</div>
		...
		<table class='table borderless' id='tabla' name='tabla'>
			...
			<tbody>
				...
				for (int i = 0; i < listaPedidos.size(); i++) {
					if (listaPedidos.get(i).getEstado().getIdEstado() == 4 && listaPedidos.get(i).getCliente().getCodCli() == cliente.getCodCli()) {
						out.println("<tr>");
